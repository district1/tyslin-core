...
Tyslon Core is the Tyslon blockchain implementation and command-line interface.
The web wallet is [Tyslon UI](https://github.com/TyslonIS/Tyslon-ui).

Visit [district1.io](https://district1.io/) to learn about Tyslon.
...
To build after all dependencies are installed:
    ...
    git clone https://github.com/TyslonIS/Tyslon-core.git
    cd tyslin-core
...
**NOTE:** Tyslon requires an [OpenSSL](https://www.openssl.org/) version in the 1.0.x series. OpenSSL 1.1.0 and newer are NOT supported. If your system OpenSSL version is newer, then you will need to manually provide an older version of OpenSSL and specify it to CMake using `-DOPENSSL_INCLUDE_DIR`, `-DOPENSSL_SSL_LIBRARY`, and `-DOPENSSL_CRYPTO_LIBRARY`.

**NOTE:** Tyslon requires a [Boost](http://www.boost.org/) version in the range [1.57, 1.63]. Versions earlier than
...
**NOTE:** By default the witness node will start in reduced memory ram mode by using some of the commands detailed in [Memory reduction for nodes](https://github.com/TyslonIS/Tyslon-core/wiki/Memory-reduction-for-nodes).
...
[here](https://github.com/TyslonIS/Tyslon-core/blob/master/libraries/wallet/include/graphene/wallet/wallet.hpp).

Support
-------
Tyslon Core bugs can be reported directly to the [issue tracker](https://github.com/TyslonIS/Tyslon-core/issues).

Tyslon UI bugs should be reported to the [UI issue tracker](https://github.com/TyslonIS/Tyslon-ui/issues)
...
- What is the meaning of `a.b.c` numbers?
    ...
    [types.hpp](https://github.com/TyslonIS/Tyslon-core/blob/master/libraries/chain/include/graphene/chain/protocol/types.hpp).
...
- The answer to the previous question was really confusing.  Can you make it clearer?
    ...
    your asset's ID will be `1.3.29`.  Asset `0` is special (it's TYS, which is considered the "core asset").
...
License
-------
Tyslon Core is under the MIT license. See [LICENSE](https://github.com/TyslonIS/Tyslon-core/blob/master/LICENSE.txt)
